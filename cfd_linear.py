...
if __name__ == "__main__":
    ...
    user_test, mesh_test = cfd_scheme.make_scheme(*filename)
    pcorrect_test = pcorrect(mesh_test)
    u_test = momentum(mesh_test, 0)
    v_test = momentum(mesh_test, 1)
    w_test = momentum(mesh_test, 2)
    k_test = turb_k(mesh_test)
    e_test = turb_e(mesh_test)
    T_test = energy(mesh_test)
    q_test = s2s(mesh_test)
